...
import { fetchNFTs } from "../api/nft-api";
import type {
  SellerProduct,
  SellerProductFilter,
...
export default function NFTModal({ isOpen, onClose }: NFTModalProps) {
  ...
  const [filterStatus, setFilterStatus] = useState<SellerProductFilter>("전체");
  ...
  const getFilteredProducts = () => {
    if (filterStatus === "전체") {
      ...
      return products.filter((product) => product.productState === "FINISHED");
    }
  };
        ...
        <div className="p-4 border-b border-gray-700 flex justify-between items-center bg-gray-800">
          <div>
            <h2 className="text-xl font-bold text-white flex items-center">
              <ShoppingBag className="w-5 h-5 text-orange-400 mr-2" />내 NFT
              컬렉션
            </h2>
          </div>
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-gradient-to-b from-gray-800 to-gray-900">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-300">NFT 목록을 불러오는 중입니다...</p>
            </div>
          ) : error ? (
                  ...
                  {viewMode === "card" && filteredProducts.length > 0 && (
                    <div className="relative flex flex-col items-center justify-center min-h-[60vh]">
                      ...
                      <div className="relative w-full max-w-md aspect-[3/4] perspective-1000">
                        ...
                        {/* 카드 뒷면 (공개 전) */}
                        {!isRevealed && (
                          <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-700 rounded-xl overflow-hidden shadow-2xl border-4 border-blue-400 flex items-center justify-center">
                            <div className="text-white text-center p-8">
                              <div className="w-24 h-24 mx-auto mb-4 text-white/80 flex items-center justify-center">
                                <svg
                                  viewBox="0 0 24 24"
                                  fill="none"
                              ...
                              <p className="text-2xl font-bold">NFT 카드</p>
                      ...
                      {!isRevealed && (
                        <button
                          className="mt-8 px-6 py-3 bg-blue-500 text-white rounded-full font-bold text-lg hover:bg-blue-600 transition-colors shadow-lg hover:shadow-blue-500/50"
