export default function OrderSkeleton() {
  return (
    <div>
      {/* 탭 네비게이션 스켈레톤 - 개별 탭 스타일 */}
      <div className="flex items-center p-4 gap-1">
        <div className="flex flex-1">
          <div className="flex-1 py-3 text-center bg-gray-200 rounded-l-lg shadow-[0_4px_8px_rgba(0,0,0,0.2)] relative z-10">
            <div className="h-5 bg-gray-300 rounded w-20 mx-auto"></div>
          </div>
          <div className="flex-1 py-3 text-center bg-gray-200 rounded-r-lg">
            <div className="h-5 bg-gray-300 rounded w-20 mx-auto"></div>
          </div>
        </div>
